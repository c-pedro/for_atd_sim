''' Setup the problem and observer. '''
...
from for_atd_sim.obs_con_ine.obs_model import setup_observer


def setup_model(smodel : SimModel, input_data : dict, settings : SimSettings):
    ''' Setup problem, sensors, and observer from input and settings. '''
